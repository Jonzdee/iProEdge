...
import { addToCart } from "../../../redux/iProEdgeSlice";
...
const ProductInfo = ({ productInfo }) => {
  ...
  <span className="text-base font-medium">Categories:</span> iPhone Cases, Chargers, Accessories Tags: New Arrival SKU: N/A
</p>
